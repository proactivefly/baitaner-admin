<template>
  <div class="dashboard-container">
    ...
    <p>
      ...
      <p>2、跳转路由时 - > 走route.beforeEach全局前置钩子 -  还未拉取用户信息 ，通过token拉取用户信息 设置state中用户roles信息（['admin','custorm',..]），还有其他信息,头像，name。。</p>
      <p>3、通过用户角色信息 对比 异步路由图谱 过滤掉不可进入的路由。添加到state中 </p>
    </p>
  </div>
</template>
